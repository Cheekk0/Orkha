...
export const FAQS: Faq[] = [
  ...
  },
  {
    ...
    a: "Because being early is the discount. Orkha is in its pilot phase, so the first 5 clients get the founding rate of ₱25,000/month for the service, moving to the ₱40,000 standard rate only once we've grown the potential customers we capture for you by 50% over the past 3 months — plus your website (a ₱20,000 build) included free, and every Future Add-On free, forever, at that locked rate once they stay past month 6. We're openly pricing in the fact that we're new. Later clients pay full price and pay for each add-on individually. We're also prepared to overdeliver early so those first results become the case studies we don't have yet.",
  },
  {
